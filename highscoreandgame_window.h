...
void get_scores(int diffuculty){
		...
		ifstream ist{"highscore"+to_string(diffuculty)+".txt"};
...
void score_sorter(int score, string nam, int difficulty){
	...
	ofstream ost{"highscore"+to_string(diffuculty)+".txt"};
	ost.trunc;
